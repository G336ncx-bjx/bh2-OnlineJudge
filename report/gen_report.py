...
<section class="cover">
  ...
  <div class="info">
    ...
    <div><strong>代码规模：</strong>后端 17 个模块 2535 行 + 前端 1899 行 = 4434 行</div>
    <div><strong>git 提交：</strong>82 次 Conventional Commits 规范提交</div>
  </div>
...
<p><strong>后端层（FastAPI，<code>app/</code>，2535 行，30+ 个异步接口）</strong>：</p>
<div class="grid">
  <div class="card">
...
<table>
  ...
  <tr><td>Step 1 题目管理</td><td><code>app/routers/problems.py</code>（168 行）</td><td>GET/POST/PUT/DELETE <code>/api/problems/</code></td><td>5</td></tr>
  <tr><td>Step 2 评测控制</td><td><code>app/judge/</code>（480 行） + <code>routers/languages.py</code>（43 行）</td><td>POST <code>/api/submissions/</code>、<code>/api/languages/</code></td><td>5</td></tr>
